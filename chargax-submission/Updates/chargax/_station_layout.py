...
class ChargingStation(eqx.Module):
    ...
    def __init__(
        ...
        num_dc_groups: int = 5,
        grid_capacity_multiplier: float = 1.0,
    ):
        ...
        # Apply multiplier to artificially limit grid capacity (for constraint testing)
        combined_total_capacity *= grid_capacity_multiplier
